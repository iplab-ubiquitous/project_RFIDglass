...
public class HttpAddDistance {
    ...
    private void datapost(short[] values) {
        ...
        if(dataCount == numOfData) {
            ...
            collectedData.put("distance", (int)Math.sqrt(tagdata[0]*tagdata[0]+tagdata[1]*tagdata[1]+tagdata[2]*tagdata[2]));
    ...
    public static void main(String[] args)  {
        ...
        reader.init(new HttpAddDistance());
